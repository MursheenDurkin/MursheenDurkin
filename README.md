...
Cyber Security and Networking student, building things
in my spare time and working on a few personal projects
...
- **SafeHaven** — network security system with a Pi-based
  firewall, WireGuard VPN, IDS integration and Flask dashboard
- **Final year dissertation** — IDS/packet capture station
...
- Boston Dynamics Spot SDK — autonomous mission scripting
- Raspberry Pi AI HAT+ — NPU-accelerated inference with YOLOv8 and Whisper
- Wazuh SIEM — log correlation and threat detection

---

## Connect

[![GitHub](https://img.shields.io/badge/GitHub-MursheenDurkin-181717?style=flat&logo=github)](https://github.com/MursheenDurkin)
